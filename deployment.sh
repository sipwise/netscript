...
vagrant_configuration() {
  ...
  sed -i 's/#AuthorizedKeysFile/AuthorizedKeysFile/g' "${TARGET}/etc/ssh/sshd_config"
  sed -i 's|^\(AuthorizedKeysFile.*\)$|\1 %h/.ssh/sipwise_vagrant_key|g' "${TARGET}/etc/ssh/sshd_config"
