...
EOT
  ...
  if "$RETRIEVE_MGMT_CONFIG" && [ "$ROLE" = "sp1" ] ; then
    ...
    logit "Coping config.yml to /mnt/glusterfs/shared_config"
    ...
    logit "Coping constants.yml to /mnt/glusterfs/shared_config"
    ...
    logit "Coping sipwise.cnf to /mnt/glusterfs/shared_config"
